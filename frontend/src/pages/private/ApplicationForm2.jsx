  ...
  return (
    <SideBar>
      <Flex gap={"10%"} w={"90%"} m>
        <Stack w={"100%"} p={10} spacing={20} ref={ref}>
          ...
          >
            ...
            <FormTextArea
              ...
              touched={
                startupSpecificData.touched.theMainValueYourSolutionBrings
              }
              helperText={
          ...
          >
            ...
            <FormTextArea
              ...
              value={
                startupSpecificData.values.primaryAndSecondaryRevenueStreams
              }
              onChange={startupSpecificData.handleChange}
              error={
                startupSpecificData.errors.primaryAndSecondaryRevenueStreams
              }
              touched={
          ...
          >
            ...
            <FormTextArea
              ...
              value={
                startupSpecificData.values.technologyThatPowersYourSolution
              }
              onChange={startupSpecificData.handleChange}
              error={
                startupSpecificData.errors.technologyThatPowersYourSolution
              }
              touched={
          ...
          >
            ...
            <FormTextArea
              ...
              value={
                startupSpecificData.values.leverageExistingCustomerSegments
              }
              onChange={startupSpecificData.handleChange}
              error={
                startupSpecificData.errors.leverageExistingCustomerSegments
              }
              touched={
          ...
          >
            ...
            <FormTextArea
              ...
              value={
                startupSpecificData.values.finalBudgetOfYourProjectPrototype
              }
              onChange={startupSpecificData.handleChange}
              error={
                startupSpecificData.errors.finalBudgetOfYourProjectPrototype
              }
              touched={
          ...
          <Stack
            ...
            spacing={10}
            color={"brand.500"}
            display={activeSection === 12 ? "block" : "none"}
          >
            <Text color={"#4BB543"} borderBottom={"2px solid"}>
              Customer FeedBack
            </Text>
          ...
          <Stack
            ...
            spacing={10}
            color={"brand.500"}
            display={activeSection === 13 ? "block" : "none"}
          >
            <Text color={"#4BB543"} borderBottom={"2px solid"}>
              Network and Partnerships
            </Text>
          ...
          <Stack
            ...
            spacing={10}
            color={"brand.500"}
            display={activeSection === 14 ? "block" : "none"}
          >
            <Text color={"#4BB543"} borderBottom={"2px solid"}>
              Execution Capability
            </Text>
          ...
          <Stack
            ...
            spacing={10}
            color={"brand.500"}
            display={activeSection === 15 ? "block" : "none"}
          >
            <Text color={"#4BB543"} borderBottom={"2px solid"}>
              Societal or Sustainability Benefit of the Solution
            </Text>
          ...
          <Stack
            ...
            spacing={10}
            color={"brand.500"}
            display={activeSection === 16 ? "block" : "none"}
          >
            <Text color={"#4BB543"} borderBottom={"2px solid"}>
              Further needed data
            </Text>
          ...
          <Stack
            ...
            spacing={10}
            color={"brand.500"}
            display={activeSection === 17 ? "block" : "none"}
          >
            <Text color={"#4BB543"} borderBottom={"2px solid"}>
              About the Program
            </Text>
            ...
            >
              ...
              {activeSection != 17 && (
                <GreenButton
                  ...
                  label={"Next"}
                  onClick={() => {
                    startupSpecificData.validateForm();
                    setActiveSection(activeSection + 1);
                  }}
                />
              )}
        ...
        >
          <Text color={"#5A7729"} fontWeight={"600"} marginLeft={"10px"}>
            Content
          </Text>
          {sections.map((section, index) => {
            ...
            return (
              <Text
                paddingX={"15px"}
                borderLeft={isActive ? "8px solid #5A7729" : "none"}
                textColor={isActive ? "#5A7729" : "#667085"}
                backgroundColor={isActive ? "#5A77294D" : "white"}
